...
export default [
  ...
  {
    path: '/docs',
    component: ComponentCreator('/docs', 'aed'),
    routes: [
      {
        path: '/docs',
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/chirpstack-guides/migrating-from-ttn-to-chirpstack',
                component: ComponentCreator('/docs/chirpstack-guides/migrating-from-ttn-to-chirpstack', '478'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
